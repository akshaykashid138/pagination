...
function changePage(page)
{
    ...
    for (var i = (page-1) * records_per_page; i < (page * records_per_page); i++) {
       id.innerHTML += objJson[i].id + "<br>";
        nameId.innerHTML += objJson[i].name + "<br>";
        email.innerHTML += objJson[i].email + "<br>";
    }
    page_span.innerHTML = page;
    currPage=current_page
    document.getElementById('page').innerHTML=current_page
    document.getElementById('page1').innerHTML=currPage+1
    document.getElementById('page2').innerHTML=currPage+2
